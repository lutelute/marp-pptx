...
## 提案の核心｜速さと正しさを 2 つの計算に分業する

```mermaid
flowchart LR
  S[感度行列 S<br>ヤコビアンから構築] --> LP[線形最適化 LP<br>全ノード一括・求解 1 秒未満]:::accent
